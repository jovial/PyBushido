Install the modified python-ant available on our github

start pyro4 naming server : python -m Pyro4.naming

start pyro4 antnode servers : python ant-server.py (if you have two usb sticks you can use ant-server2.py - used with the man in the middle attack as was getting collisons with the one stick using two channels )
